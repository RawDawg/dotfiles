...
SYSTEM_TIME="${SPACESHIP_SYSTEMTIME:="%{$fg[white]%}%T%{$fg[magenta]%}"}"
...
SPACESHIP_GIT_STATUS_COLOR="${SPACESHIP_GIT_STATUS_COLOR:="magenta"}"
SPACESHIP_GIT_STATUS_UNTRACKED="${SPACESHIP_GIT_STATUS_UNTRACKED:="%{$fg[grey]%} ✱ %{$fg[magenta]%}"}"
SPACESHIP_GIT_STATUS_ADDED="${SPACESHIP_GIT_STATUS_ADDED:="%{$fg[green]%} + %{$fg[magenta]%}"}"
SPACESHIP_GIT_STATUS_MODIFIED="${SPACESHIP_GIT_STATUS_MODIFIED:="%{$fg[yellow]%} ! %{$fg[magenta]%}"}"
SPACESHIP_GIT_STATUS_RENAMED="${SPACESHIP_GIT_STATUS_RENAMED:="{$fg[yellow]%} » %{$fg[magenta]%}"}"
SPACESHIP_GIT_STATUS_DELETED="${SPACESHIP_GIT_STATUS_DELETED:="%{$fg[red]%} ✘ %{$fg[magenta]%}"}"
SPACESHIP_GIT_STATUS_STASHED="${SPACESHIP_GIT_STATUS_STASHED:="%{$fg[grey]%} $ %{$fg[magenta]%}"}"
SPACESHIP_GIT_STATUS_UNMERGED="${SPACESHIP_GIT_STATUS_UNMERGED:="%{$fg[magenta]%} = %{$fg[magenta]%}"}"
SPACESHIP_GIT_STATUS_AHEAD="${SPACESHIP_GIT_STATUS_AHEAD:="%{$fg[white]%} ⇡ %{$fg[magenta]%}"}"
SPACESHIP_GIT_STATUS_BEHIND="${SPACESHIP_GIT_STATUS_BEHIND:="%{$fg[white]%} ⇣ %{$fg[magenta]%}"}"
SPACESHIP_GIT_STATUS_DIVERGED="${SPACESHIP_GIT_STATUS_DIVERGED:="%{$fg[white]%} ⇕ %{$fg[magenta]%}"}"
...
SPACESHIP_PACKAGE_SYMBOL="${SPACESHIP_PACKAGE_SYMBOL:="◼︎ "}"
...
spaceship_char() {
  _prompt_section "%(?.magenta.red)" "${SPACESHIP_PROMPT_SYMBOL} "
}
...
spaceship_setup() {
  ...
  PS2='$(spaceship_ps2)'
  RPS1='$(spaceship_rprompt)$SYSTEM_TIME'
